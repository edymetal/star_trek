...
| A-015 | A primeira narrativa será uma pequena sequência guiada com três missões reutilizando sistemas. | Fecha o ciclo com escopo controlado. | A primeira missão de exploração reutiliza sensores, arena e base; assistência e combate permanecem para a etapa seguinte. | Parcialmente validada no P1 |
